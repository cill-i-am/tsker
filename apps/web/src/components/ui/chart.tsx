...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  const colorConfig = Object.entries(config).filter(
    ([, chartItem]) => chartItem.theme || chartItem.color,
  );
...
${colorConfig
  .map(([key, chartItem]) => {
    const color = chartItem.theme?.[theme as keyof typeof chartItem.theme] || chartItem.color;
...
type TooltipPayload = NonNullable<RechartsTooltipProps["payload"]>;
